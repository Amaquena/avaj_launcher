		...
		try {
			switch (weather) {
				...
				case "RAIN":
					...
					simulator.Simulator.newFile.write("Helicopter#" + this.name + "(" + this.id + "): " + "I can't see like this.\n");
					break;
				case "FOG":
					this.coordinates = new Coordinates(this.coordinates.getLongitude() + 1,
							this.coordinates.getLatitide(), this.coordinates.getHeight());
					simulator.Simulator.newFile.write("Helicopter#" + this.name + "(" + this.id + "): " + "Where are we?\n");
					break;
				case "SNOW":
					this.coordinates = new Coordinates(this.coordinates.getLongitude(), this.coordinates.getLatitide(),
							this.coordinates.getHeight() - 12);
					simulator.Simulator.newFile.write("Helicopter#" + this.name + "(" + this.id + "): " + "We're falling!\n");
